        ...
        {user.username && (
          <>
            <button className="px-2 py-1">
              <img src={Triangle} alt="" className="text-gray-400 w-6 h-6 mx-2" />
            </button>
             {user.username && (
          <>
            {/* <Button
            ...
            <button className="px-2 py-1" onClick={() => PostFormModal.setShow("createPost")}> 
              <img src={Add} alt="Add Ideas" className="text-gray-400 w-6 h-6 mx-2" />
            </button>
            ...
            <button className="px-2 py-1">
              <img src={JobBoard} alt="JobBoard" className="text-gray-400 w-6 h-6 mx-2" />
            </button>
          </>
        )}
