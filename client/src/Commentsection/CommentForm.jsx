    ...
    return (
        <div className={"text-reddit_text"}>
            ...
            <form onSubmit={(e) => postComment(e)}>
                <Textarea className="w-full mb-3 border border-reddit_border" onChange={(e) => setCommentBody(e.target.value)} value={commentBody} placeholder={"Your comment. You can use markdown here"} />
                <div className="text-right">
                    {!!props.onCancel && (
                        <Button outline className="p-2 mr-2" onClick={(e) => props.onCancel()}>
                            Cancel
                        </Button>
                    )}
