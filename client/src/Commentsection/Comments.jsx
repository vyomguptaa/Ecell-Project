                    ...
                    <div className={"mb-2"}>
                        ...
                        <div className="border-l-2 border-reddit_text-darker p-3 pb-0" style={{ marginLeft: "18px" }}>
                            <div className="pl-4 -mt-4">
                                ...
                                <Button type={"button"} onClick={() => setShowForm(comment._id)} className="bg-reddit_dark-brighter text-reddit_text-darker border-none py-2 pl-0 pr-0">
                                    Reply
                                </Button>
                                ...
                                {replies.length > 0 && <Comments comments={props.comments} parentId={comment._id} rootId={props.rootId} />}
                            </div>
                        </div>
                    </div>
                );
